    ...
    <section class="faq" id="faq">
      <div class="faq__wrapper container">
        <div class="faq__content">
          <h2 class="title-h1">Листок-вкладыш<br> Троксевазин<sup>®</sup> Нео</h2>
          <div class="instruction">
            <div class="instruction__list">
              <div @click="toggleAccordion" class="instruction__item">
                ...
                <div class="instruction__desc">Действующими веществами препарата Троксевазин® Нео являются гепарин натрия, декспантенол и троксерутин. Препарат относится к группе: «антикоагулянтное средство прямого действия для местного применения + прочие препараты».
Троксевазин® Нео – комбинированный препарат для наружного применения при варикозном расширении вен и хронической венозной недостаточности (устранение и облегчение симптомов).
Действие препарата обусловлено входящими в его состав веществами.
Троксерутин – средство, укрепляющее и защищающее вены и капилляры. Троксерутин уменьшает проницаемость и ломкость капилляров, повышает их тонус, увеличивает
плотность сосудистой стенки и снижает её воспаление. Способствует улучшению микроциркуляции и питания тканей, уменьшает застойные явления. Троксерутин оказывает
венотонизирующее, венопротекторное, противоотечное, противовоспалительное, противосвертывающее и антиоксидантное действие.
Гепарин – антикоагулянт прямого действия, естественный противосвертывающий фактор организма. Препятствует образованию тромбов, улучшает местный кровоток. Оказывает противовоспалительное действие, способствует регенерации соединительной ткани.
Декспантенол (провитамин B5) улучшает всасывание гепарина, улучшает обменные процессы в коже, способствует регенерации поврежденных тканей.</div>
              </div>
              <div @click="toggleAccordion" class="instruction__item">
                <div class="instruction__title">
              ...
              <div @click="toggleAccordion" class="instruction__item">
                <div class="instruction__title">
                  <h5>Препарат Троксевазин® Нео содержит метилпарагидроксибензоат и пропилпарагидроксибензоат</h5>
                  <div class="accordion-btn"></div>
                </div>
                <div class="instruction__desc">
                  Препарат Троксевазин® Нео содержит метилпарагидроксибензоат и пропилпарагидроксибензоат, который может вызывать аллергические реакции (в том числе, отсроченные).
                </div>
              </div>
            </div>
            <!-- 2 column   -->
            <div class="instruction__list">
              ...
              <div @click="toggleAccordion" class="instruction__item">
                ...
                <div class="instruction__desc">
                  Актавис Групп ПТС ехф.,<br>Дальшраун 1, 220 Хафнарфьердур, Исланди
                </div>
              </div>
              <div @click="toggleAccordion" class="instruction__item">
                <div class="instruction__title">
          ...
          <div class="faq__download">
            <a href="/pdf/instruction_neo-v2.pdf" download>
